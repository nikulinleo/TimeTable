...
namespace HelloApp
{
    class StartPage : Shell
    {
        void load()
        {
            ...
            DB.Idiots["Агата"] = new Idiot("Агата");
            DB.Idiots["Агата"].AddPair("Алгоритмы и алгоритмические языки+8.45+10.20+zoom+Белеванцев А.А.+1+0,1,2,3+лекция");
            DB.Idiots["Агата"].AddPair("Алгебра и геометрия+10.30+12.05+zoom+Тыртышников Е.Е.+1+0,1,2,3+лекция");
            DB.Idiots["Агата"].AddPair("Математический анализ+12.50+14.25+zoom+Садовничая И.В.+1+0,1,2,3+лекция");
            DB.Idiots["Агата"].AddPair("История+14.35+16.10+zoom+Чубыкин И.В.+1+0,2+лекция ");
            DB.Idiots["Агата"].AddPair("Физкультура+14.35+16.10+zoom++1+1,3+лекция");
            DB.Idiots["Агата"].AddPair("БЖД+16.20+17.55+G classroom++1+0,1,2,3+лекция");
            DB.Idiots["Агата"].AddPair("Алгебра и геометрия+10.30+12.05+503+Востриков И.В.+2+0,1,2,3+семинар");
            DB.Idiots["Агата"].AddPair("Математический анализ+12.50+14.25+605+Хорошилова Е.В.+2+0,1,2,3+семинар");
            DB.Idiots["Агата"].AddPair("Практикум на ЭВМ+14.35+16.10+682+Манушин Д.В.+2+0,1,2,3+семинар");
            DB.Idiots["Агата"].AddPair("Алгоритмы и алгоритмические языки+8.45+10.20+zoom+Белеванцев А.А.+3+0,1,2,3+лекция");
            DB.Idiots["Агата"].AddPair("Алгебра и геометрия+10.30+12.05+zoom+Тыртышников Е.Е.+3+0,1,2,3+лекция");
            DB.Idiots["Агата"].AddPair("Математический анализ+12.50+14.25+zoom+Садовничая И.В.+3+0,1,2,3+лекция");
            DB.Idiots["Агата"].AddPair("Физкультура+8.45+10.20+малый газон+Святослав Олегович+4+0,1,2,3+семинар ");
            DB.Idiots["Агата"].AddPair("Алгебра и геометрия+10.30+12.05+504+Востриков И.В.+4+0,1,2,3+семинар ");
            DB.Idiots["Агата"].AddPair("Английский язык+12.50+14.25+735+Кашелкина О.А.+4+0,1,2,3+семинар ");
            DB.Idiots["Агата"].AddPair("Практикум на ЭВМ+14.35+16.10+248+Манушин Д.В.+4+0,1,2,3+семинар ");
            DB.Idiots["Агата"].AddPair("История+10.30+12.05+526-б+Чубыкин И.В.+5+0,1,2,3+семинар");
            DB.Idiots["Агата"].AddPair("Математический анализ+12.50+14.25+707+Хорошилова Е.В.+5+0,1,2,3+семинар");
            DB.Idiots["Агата"].AddPair("Английский язык+14.35+16.10+783+Кашелкина О.А.+5+0,1,2,3+семинар");
